...
SECRET_KEY = 'django-insecure-%m7(v$b=@6f!8i6je9kb9r03wn_t4@++-l*z4++4knzukk*%k^'
...
EMAIL_HOST_USER = 'libraryhost2024@gmail.com'
EMAIL_HOST_PASSWORD = 'firw srkc qdet mgjl'  # Your email password
EMAIL_PORT = 587
EMAIL_USE_TLS = True
...
import os
MEDIA_URL = 'media/'
STATIC_ROOT = os.path.join(BASE_DIR, 'fitness_tracker/static')
